...
import { fadeUp, springGentle, easeOutExpo } from "@/lib/animations";
...
export function ProjectCard({ project, index }: ProjectCardProps) {
  ...
  return (
    <motion.article
      ref={ref}
      className="group relative overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.02] transition-all duration-500 hover:border-white/[0.12] hover:bg-white/[0.03] hover:shadow-[0_0_40px_rgba(255,255,255,0.02)]"
      variants={fadeUp}
      initial="hidden"
