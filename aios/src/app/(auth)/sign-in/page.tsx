  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <h1 className="text-lg font-semibold tracking-tight">Welcome to AIOS</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Sign in to your engineering operating system
        </p>
      </div>
      ...
      <div className="space-y-3">
        <button
          ...
          disabled={loading}
          className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-border bg-elevation-1 px-4 py-2.5 text-sm font-medium transition-colors hover:bg-elevation-2 disabled:opacity-50"
        >
      ...
      <p className="text-center text-xs text-muted-foreground">
        ...
        <button className="text-accent-green hover:underline">Sign up</button>
      </p>
    </div>
  );
}
