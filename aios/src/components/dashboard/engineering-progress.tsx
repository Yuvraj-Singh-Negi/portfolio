...
const skills: SkillCard[] = [
  {
    ...
    projects: 8,
    lastActivity: "2h ago",
    recommendation: "Explore async patterns",
  ...
  },
  {
    ...
    projects: 4,
    lastActivity: "1d ago",
    recommendation: "Linear algebra review",
  ...
  },
  {
    ...
    projects: 5,
    lastActivity: "3d ago",
    recommendation: "Graph algorithms",
  ...
  },
  {
    ...
    projects: 6,
    lastActivity: "Today",
    recommendation: "Rate limiting patterns",
  ...
  },
  {
    ...
    projects: 7,
    lastActivity: "2d ago",
    recommendation: "React Server Components",
    color: "text-accent-blue",
    icon: TrendingUp,
  },
  {
  ...
  },
  {
    ...
    projects: 2,
    lastActivity: "1w ago",
    recommendation: "Start with linear regression",
    color: "text-accent-purple",
    icon: TrendingUp,
  },
  {
    ...
    projects: 1,
    lastActivity: "2w ago",
    recommendation: "Transformer architecture",
    color: "text-accent-green",
    icon: TrendingUp,
  },
  {
    ...
    projects: 4,
    lastActivity: "4d ago",
    recommendation: "Consensus algorithms",
